          ...
          {items.map(item => (
            <div key={item.id} className="card p-4 flex gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base font-bold text-slate-800 mt-1">₹{item.price.toLocaleString()}</p>
              </div>
              <div className="flex flex-col items-end gap-3">
                ...
                <p className="text-sm font-bold text-primary-600">₹{(item.price * item.qty).toLocaleString()}</p>
              </div>
            </div>
          ))}
        </div>
