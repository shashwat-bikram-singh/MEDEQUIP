  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-slate-800 dark:text-white mb-2">All Categories</h1>
        <p className="text-slate-500 dark:text-slate-400">Browse our complete range of medical supplies by category</p>
      </div>
